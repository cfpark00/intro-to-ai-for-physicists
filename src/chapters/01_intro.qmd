...
[<i class="bi bi-github"></i>&nbsp;Chapter code on GitHub →](https://github.com/cfpark00/science-of-dl/tree/main/src/code/chapters/01_intro){.btn .btn-outline-secondary .btn-sm role="button"}
...
- **Over-parametrization**: classical statistical learning theory predicted that models with vastly more parameters than data points should overfit catastrophically. They did not. This is still surprising. The phenomena that came out of *not* overfitting, double descent, grokking, the general "deep learning works much better than it should", are the substance of [Chapter 7](07_scidl_training.qmd). Modern theory (NTK, capacity arguments, implicit-regularization stories) has made real progress here; "still surprising" is the empirical statement, not a slight on the theoretical work that is closing the gap.
