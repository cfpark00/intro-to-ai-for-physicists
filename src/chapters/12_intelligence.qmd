...
[<i class="bi bi-github"></i>&nbsp;Chapter code on GitHub →](https://github.com/cfpark00/science-of-dl/tree/main/src/code/chapters/12_intelligence){.btn .btn-outline-secondary .btn-sm role="button"}
