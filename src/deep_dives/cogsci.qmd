...
[<i class="bi bi-github"></i>&nbsp;Deep-dive code on GitHub →](https://github.com/cfpark00/science-of-dl/tree/main/src/code/deep_dives/cogsci){.btn .btn-outline-secondary .btn-sm role="button"}
